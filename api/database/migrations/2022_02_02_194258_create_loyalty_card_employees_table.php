...
class CreateLoyaltyCardEmployeesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('loyalty_card_employees', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('loyalty_card_employees');
    }
}
